...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-darkCustom dark:border-gray-700" aria-label="Sidebar">
   <div class="flex h-full  pb-4 overflow-y-auto bg-white dark:bg-darkCustom ">
      <!-- tira de color azul iconos -->
      <div class="h-full w-14 bg-blue-600">
         <div class="main-icon-menu">
            <a href="/dashboard" class="logo logo-metrica d-block text-center">
                <span>
                    <img src="{{asset('assets/images/logo.png')}}" alt="logo-small" class="rounded-circle me-2 thumb-sm">
                </span>
            </a>
