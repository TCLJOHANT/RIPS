...
return new class extends Migration
{
    ...
    {
        Schema::create('lst_si_no', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('Extra_I:ListSINO12', 50)->nullable();
            $table->string('Extra_II:ListSINOSN', 50)->nullable();
            $table->string('Extra_III:ListSINO10', 50)->nullable();
